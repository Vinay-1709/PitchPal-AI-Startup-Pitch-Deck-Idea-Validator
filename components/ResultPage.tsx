...
import { CheckCircle2, TrendingUp, Users, ShieldAlert, BadgeDollarSign, BookOpen, IndianRupee, PieChart as PieIcon, Lightbulb, MessageSquare, ExternalLink } from 'lucide-react';
...
const ResultPage: React.FC<ResultPageProps> = ({ data, onReset, originalIdea = "" }) => {
  ...
  const handleChatWithAI = () => {
    window.open('https://agent.ai/profile/nakddeq75tupwt1f', '_blank');
  };
